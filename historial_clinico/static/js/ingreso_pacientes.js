    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        if (response.status === "success") {
          ...
          // Cierra el modal y elimina la capa de fondo
          $("#addIngresoPacientesModal").modal("hide"); // Cierra el modal
          $(".modal-backdrop").remove(); // Elimina la capa de fondo gris
          $("body").removeClass("modal-open"); // Elimina la clase modal-open que puede generar problemas visuales
        } else {
    ...
    $.ajax({
      ...
      success: function (response) {
        if (response.status === "success") {
          ...
          $(".modal-backdrop").remove(); // Eliminar la capa de fondo gris
          $("body").removeClass("modal-open"); // Eliminar la clase modal-open que puede generar problemas visuales
        } else {
